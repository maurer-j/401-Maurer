...
Using 2 weeks, we have 761 injured cases vs. 25,193 non-injured cases, a large imbalance. We also see that days_before produce 15803 NA values, meaning these were the total jumps from non-injured athletes. We will now extend that window to 4 weeks to see if we capture more injured cases and slower-developing fatigue patterns. 
