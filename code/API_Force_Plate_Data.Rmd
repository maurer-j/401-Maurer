...
# This is the file that connects with the Hawkin API to pull force plate jumps for the 2024-2025 academic year. For ease of use, the pulled jumps were then turned into a .csv file that will be referenced in future code. Only authorized personnel can gain access to the API as it contains sensitive athlete information. After retrieval, athlete names were matched with a unique identifier, then removed after combination with the injury dataset. 
...
# API code for authorized use only
